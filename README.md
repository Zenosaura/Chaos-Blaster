...
> **The easiest way to play is to download a playable build directly from the [Releases](https://github.com/your-username/Chaos-Blaster/releases) tab of this repository.**
